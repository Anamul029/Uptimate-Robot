...
const FreeAccount = () => {
    return (
        <div className="my-20 py-10">
            <h1 className="font-bold text-center text-2xl  md:text-4xl">Get your <span className="text-teal-600">FREE account</span> now,<br />
                100 monitors included!</h1>
            <div className="flex justify-center items-center">
                <button className="mt-4 font-semibold bg-teal-600 hover:bg-blue-400  text-white py-3 px-4 rounded-4xl shadow-[0px_4px_10px_rgba(0,0,0,0.2)]   transition-all">
