    ...
    return (
        <div className="max-w-[1900px] px-[10%] mx-auto">
            ...
            <div className="flex justify-center items-center">
                <button className="mt-4 font-semibold bg-[#3bd671] hover:bg-green-500 cursor-pointer text-white py-2 px-4 rounded-4xl shadow-[0px_4px_10px_rgba(0,0,0,0.2)]   transition-all">
